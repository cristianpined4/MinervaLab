@section('title', 'Administrar calendarios')
        ...
        <div class="flex-1 p-6 md:p-8 lg:p-10">
            <div class="max-w-7xl mx-auto">
                ...
                <div class="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div>
                        <h1 class="text-3xl md:text-4xl font-bold text-gray-800 mb-2">Administrar calendarios</h1>
                        <p class="text-gray-600">Gestion de dias festivos, asueto, feriado y eventos</p>
                    </div>
                        ...
                        <table class="w-full">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="text-sm text-gray-900 font-medium">Feria de logros</div>
                                        <div class="text-sm text-gray-500">Feria de economia</div>
                                    </td>
