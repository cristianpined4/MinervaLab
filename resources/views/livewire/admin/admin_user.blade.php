                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <div class="form-group">
                            <label class="block text-sm font-semibold text-white mb-2">Nombre de usuario
                        ...
                        <div class="form-group">
                            <label class="block text-sm font-semibold text-white mb-2">Nombre
                        ...
                        <div class="form-group">
                            <label class="block text-sm font-semibold text-white mb-2">Apellido
                        ...
                        <div class="form-group">
                            <label class="block text-sm font-semibold text-white mb-2">Edad
                            @error('fields.age')
                                <span class="text-red-500 text-sm">* {{ $message }}</span>
                            @enderror</label>
                        ...
                        <div class="form-group">
                            <label class="block text-sm font-semibold text-white mb-2">Correo electrónico
                            @error('fields.email')
                                <span class="text-red-500 text-sm">* {{ $message }}</span>
                            @enderror</label>
                        ...
                        <div class="form-group">
                            <label class="block text-sm font-semibold text-white mb-2">Teléfono
                            @error('fields.phone')
                                <span class="text-red-500 text-sm">* {{ $message }}</span>
                            @enderror</label>
                        ...
                        <div class="form-group">
                            <label class="block text-sm font-semibold text-white mb-2">Contraseña
                        ...
                        <div class="form-group">
                            <label class="block text-sm font-semibold text-white mb-2">Rol de usuario
                            @error('fields.id_rol')
                                <span class="text-red-500 text-sm">* {{ $message }}</span>
                            @enderror</label>
                        ...
                        <div class="form-group">
                            <label class="block text-sm font-semibold text-white mb-2">Facultad
        ...
        <div class="flex-1 p-6 md:p-8 lg:p-10">
            <div class="max-w-7xl mx-auto">
                ...
                <div class="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div>
                        <h1 class="text-3xl md:text-4xl font-bold text-white mb-2">Administrar usuarios</h1>
                        <p class="text-white/60">Administracion de usuarios y permisos</p>
                    </div>
