                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <input wire:model="fields.entry_date" type="date" id="entry_date"
                                class="js-picker-date w-full bg-white/5 border rounded-xl px-4 py-3 text-white placeholder-white/40 focus:ring-2 focus:ring-cyan-400 focus:border-cyan-400 transition">
                            ...
                            <tbody class="divide-y divide-white/20">
                                @foreach ($data as $row)
                                    <tr class="hover:bg-white/5 transition-colors">
                                        ...
                                        <td class="px-6 py-4">
                                            <span class="text-sm font-medium text-white">{{ $row->usefull_years }}</span>
                                        </td>
                    ...
                    <div class="bg-white/5 px-6 py-4 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-3">
                        <div class="text-sm text-white/60">
                            @if($data->total() > 0)
                                ...
                                de <span class="font-semibold text-white">{{ $data->total() }}</span> lentes
                            @else
