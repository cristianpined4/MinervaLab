        ...
        <div class="flex-1 p-6 md:p-8 lg:p-10">
            <div class="max-w-7xl">
                ...
                <div class="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div>
                        <h1 class="text-3xl md:text-4xl font-bold text-white mb-2">Mis Reservaciones</h1>
                        <p class="text-white/60">Administra todas tus reservaciones de espacios</p>
                    </div>
                ...
                <div class="bg-white/5 rounded-2xl border border-white/10 shadow-lg overflow-hidden border border-white/10">
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            <thead class="bg-white/5 border-b-2 border-white/10">
                                <tr>
                                    <th class="px-6 py-4 text-left text-xs font-bold text-white/60 uppercase tracking-wider">
                                        Fecha
                                    </th>
                                    <th class="px-6 py-4 text-left text-xs font-bold text-white/60 uppercase tracking-wider">
                                        Hora
                                    ...
                                    <th class="px-6 py-4 text-center text-xs font-bold text-white/60 uppercase tracking-wider">
                                        Acciones
                                    </th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-white/20">
                                ...
                                <tr class="hover:bg-white/5 transition-colors">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <span class="text-sm font-medium text-white">22/10/2025</span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <span class="text-sm text-white">10:00 AM</span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="text-sm text-white font-medium">Sala de Conferencias</div>
                                        <div class="text-sm text-white/50">Reunión de equipo</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center gap-2">
                                            <div class="flex -space-x-2">
                                                <div class="w-8 h-8 bg-white/50 rounded-full border-2 border-white flex items-center justify-center">
                                                    <svg class="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                                                        <path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd"/>
                                                    </svg>
                                                </div>
                                            </div>
                                            <span class="text-sm font-semibold text-white">12 personas</span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-center">
                                        <div class="flex items-center justify-center gap-2">
                                            <button class="p-2 bg-blue-600 hover:bg-blue-700 text-white inline-flex items-center justify-center rounded-lg transition-colors" title="Editar">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                                </svg>
                                            </button>
                                            <button class="p-2 bg-red-600 hover:bg-red-700 text-white inline-flex items-center justify-center rounded-lg transition-colors" title="Eliminar">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <tr class="hover:bg-white/5 transition-colors">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <span class="text-sm font-medium text-white">25/10/2025</span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <span class="text-sm text-white">2:00 PM</span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="text-sm text-white font-medium">Laboratorio de Computación</div>
                                        <div class="text-sm text-white/50">Práctica de programación</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center gap-2">
                                            <div class="flex -space-x-2">
                                            ...
                                            <span class="text-sm font-semibold text-white">8 personas</span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-center">
                                        <div class="flex items-center justify-center gap-2">
                                ...
                                <tr class="hover:bg-white/5 transition-colors">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <span class="text-sm font-medium text-white">28/10/2025</span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <span class="text-sm text-white">4:30 PM</span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="text-sm text-white font-medium">Auditorio Principal</div>
                                        <div class="text-sm text-white/50">Presentación de proyecto</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center gap-2">
                                            <div class="flex -space-x-2">
                                            ...
                                            <span class="text-sm font-semibold text-white">25 personas</span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-center">
                                        <div class="flex items-center justify-center gap-2">
                                ...
                                <tr>
                                    <td colspan="5" class="px-6 py-12 text-center">
                                        ...
                                        <p class="text-white/40 text-sm mt-2">Haz clic en "Agregar Reservación" para crear una nueva</p>
                                    </td>
                                </tr>
                                @endif --}}
                            </tbody>
                    ...
                    <div class="bg-white/5 px-6 py-4 border-t border-white/10 flex items-center justify-between">
                        <div class="text-sm text-white/60">
                            Mostrando <span class="font-semibold text-white">1-3</span> de <span class="font-semibold text-white">3</span> reservaciones
                        </div>
                        <div class="flex gap-2">
                            <button class="px-4 py-2 bg-white/5 border border-white/20 rounded-lg text-sm font-medium text-white hover:bg-white/5 transition-colors disabled:opacity-50 disabled:cursor-not-allowed" disabled>
                                Anterior
                            </button>
                            <button class="px-4 py-2 bg-white/5 border border-white/20 rounded-lg text-sm font-medium text-white hover:bg-white/5 transition-colors disabled:opacity-50 disabled:cursor-not-allowed" disabled>
                                Siguiente
